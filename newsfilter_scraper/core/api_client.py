...
class NewsfilterAPIClient:
    ...
    def __init__(
        self,
        api_key: str,
        base_url: str = "https://api.newsfilter.io",
        timeout: int = 30,
    ...
    def authenticate(self) -> bool:
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                self.logger.error(
                    f"API authentication failed: {response.status_code if response else 'No response'}"
                )
                return False
    ...
    def get_articles(
        ...
        try:
            response = self._make_request(
                "GET", "/articles", params=params, authenticate=True
            )
        ...
        for attempt in range(self.retry_attempts + 1):
            try:
                ...
                if attempt < self.retry_attempts:
                    ...
                    raise NewsfilterAPIError(
                        f"Connection error after {self.retry_attempts} attempts"
                    )
    ...
    def get_sources(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            if response and response.status_code == 200:
                ...
                raise NewsfilterAPIError(
                    f"Failed to fetch sources: {response.status_code if response else 'No response'}"
                )
    ...
    def check_rate_limit_status(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"remaining": 0, "reset_time": None, "error": str(e)}
