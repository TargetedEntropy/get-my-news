...
class Settings:
    ...
    def __init__(self, env_file: Optional[str] = None):
        ...
        self.process_lock_file = self._get_env_path("PROCESS_LOCK_FILE", "/tmp/newsfilter_scraper.lock")
    ...
    def _load_logging_config(self) -> LoggingConfig:
        ...
        return LoggingConfig(
            ...
            structured_format=os.getenv("STRUCTURED_LOGGING", "false").lower() == "true"
        )
    ...
    def _validate_config(self):
        ...
        if not self.database.url.startswith(('mysql+pymysql://', 'mysql://', 'sqlite:///')):
            errors.append("DATABASE_URL must start with mysql+pymysql://, mysql://, or sqlite:///")
    ...
    def print_config_summary(self):
        ...
        print(f"Environment: {'Development' if self.is_development() else 'Production'}")
