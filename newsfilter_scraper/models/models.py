...
class Symbol(Base):
    ...
    articles = relationship("Article", secondary=article_symbols, back_populates="symbols")
...
class Article(Base):
    ...
    symbols = relationship("Symbol", secondary=article_symbols, back_populates="articles")
